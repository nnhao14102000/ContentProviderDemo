...
public class ToolUtilities {
    ...
    public static String copyFileFromDataDirToSDCard(String desDirectory,
                                                     String srcDirectory) {
        ...
        if (fileList != null) {
            result += "- File located at directory: \n";
            ...
            result += "- File located at directory: No File\n";
        }
        return result;
    }
    ...
    public static void copyDBFromAssetToData(String fileName, String desDirectory, Context context) throws IOException{
